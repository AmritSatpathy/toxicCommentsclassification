...
from keras.layers import Embedding, Input, Dense, LSTM, Bidirectional, TimeDistributed
...
model.fit(x_train, y_train, validation_data=(x_val, y_val),epochs=3, batch_size=600,  callbacks=[RocAuc],verbose=2)
