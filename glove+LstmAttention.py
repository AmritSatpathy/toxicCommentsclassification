...
hist = model.fit(data_train, labels_train, validation_data=(data_val, labels_val), epochs=3, batch_size=256, shuffle=True, callbacks=[early_stopping, model_checkpoint],verbose=2)
